...
SEED_UCS_TABLE: list[dict] = [
    ...
    {"catid": "DOORWood", "category": "DOORS", "subcategory": "Wood",
     "synonyms": ["wooden door", "oak door", "door creak", "door open",
                  "door close", "door slam"], "confident": True},
    {"catid": "DOORMetal", "category": "DOORS", "subcategory": "Metal",
     "synonyms": ["metal door", "steel door", "hatch", "cell door"], "confident": False},
    {"catid": "DOORKnob", "category": "DOORS", "subcategory": "Knob",
     "synonyms": ["doorknob", "door handle", "latch", "handle turn"], "confident": False},

    # --- WEATHER ---
    {"catid": "WEATHRain", "category": "WEATHER", "subcategory": "Rain",
     "synonyms": ["rain", "rainfall", "raining", "rain on window", "downpour",
                  "drizzle"], "confident": True},
    {"catid": "WEATHWind", "category": "WEATHER", "subcategory": "Wind",
     "synonyms": ["wind", "gust", "breeze", "howling wind", "windy"], "confident": False},
    {"catid": "WEATHThunder", "category": "WEATHER", "subcategory": "Thunder",
     "synonyms": ["thunder", "thunderclap", "thunderstorm", "thunder crack",
                  "rumble"], "confident": False},

    # --- FOOTSTEPS ---
    {"catid": "FOOTWood", "category": "FOOTSTEPS", "subcategory": "Wood",
     "synonyms": ["footsteps wood", "walking wood floor", "footfall wood"],
     "confident": False},
    {"catid": "FOOTConc", "category": "FOOTSTEPS", "subcategory": "Concrete",
     "synonyms": ["footsteps concrete", "walking pavement", "footsteps sidewalk"],
     "confident": False},
    {"catid": "FOOTGravel", "category": "FOOTSTEPS", "subcategory": "Gravel",
     "synonyms": ["footsteps gravel", "walking gravel", "crunch gravel"],
     "confident": False},

    # --- IMPACTS / DESTRUCTION / GLASS ---
    {"catid": "IMPTGeneral", "category": "IMPACTS", "subcategory": "General",
     "synonyms": ["impact", "hit", "thud", "bang", "smash", "crash"], "confident": False},
    {"catid": "DESTGeneral", "category": "DESTRUCTION", "subcategory": "General",
     "synonyms": ["destruction", "collapse", "debris", "rubble", "demolition"],
     "confident": False},
    {"catid": "GLASBreak", "category": "GLASS", "subcategory": "Break",
     "synonyms": ["glass break", "glass shatter", "shattering glass",
                  "broken glass"], "confident": False},

    # --- WATER / LIQUID ---
    {"catid": "WATRRun", "category": "WATER", "subcategory": "Running",
     "synonyms": ["running water", "stream", "faucet", "tap water",
                  "flowing water"], "confident": False},
    {"catid": "WATRSplash", "category": "WATER", "subcategory": "Splash",
     "synonyms": ["splash", "splashing", "water splash", "plop"], "confident": False},
    {"catid": "LIQDPour", "category": "LIQUID", "subcategory": "Pour",
     "synonyms": ["pour", "pouring", "glug", "liquid pour"], "confident": False},

    # --- FIRE ---
    {"catid": "FIREGeneral", "category": "FIRE", "subcategory": "General",
     "synonyms": ["fire", "flames", "campfire", "crackling fire", "burning"],
     "confident": False},
    {"catid": "FIREWhoosh", "category": "FIRE", "subcategory": "Whoosh",
     "synonyms": ["fire whoosh", "flame burst", "fireball", "ignite whoosh"],
     "confident": False},

    # --- VEHICLES ---
    {"catid": "VEHCarInt", "category": "VEHICLES", "subcategory": "Car Interior",
     "synonyms": ["car interior", "in car", "car cabin"], "confident": False},
    {"catid": "VEHCarExt", "category": "VEHICLES", "subcategory": "Car Exterior",
     "synonyms": ["car pass by", "car exterior", "car drive by", "engine car"],
     "confident": False},
    {"catid": "VEHHorn", "category": "VEHICLES", "subcategory": "Horn",
     "synonyms": ["car horn", "honk", "vehicle horn", "beep horn"], "confident": False},

    # --- AMBIENCE ---
    {"catid": "AMBUrban", "category": "AMBIENCE", "subcategory": "Urban",
     "synonyms": ["city ambience", "street ambience", "urban background",
                  "traffic ambience"], "confident": False},
    {"catid": "AMBNature", "category": "AMBIENCE", "subcategory": "Nature",
     "synonyms": ["nature ambience", "forest ambience", "outdoor ambience",
                  "birdsong bed"], "confident": False},
    {"catid": "AMBRoom", "category": "AMBIENCE", "subcategory": "Room Tone",
     "synonyms": ["room tone", "roomtone", "interior ambience", "quiet room"],
     "confident": False},

    # --- USER INTERFACE / DESIGNED ---
    {"catid": "GUIBeep", "category": "USER INTERFACE", "subcategory": "Beep",
     "synonyms": ["ui beep", "button", "menu click", "notification", "ui blip"],
     "confident": False},
    {"catid": "GUIWhoosh", "category": "USER INTERFACE", "subcategory": "Whoosh",
     "synonyms": ["ui whoosh", "swipe", "ui swipe", "transition whoosh"],
     "confident": False},

    # --- ANIMALS ---
    {"catid": "ANMLDog", "category": "ANIMALS", "subcategory": "Dog",
     "synonyms": ["dog", "bark", "dog bark", "growl", "whine dog"], "confident": False},
    {"catid": "ANMLCat", "category": "ANIMALS", "subcategory": "Cat",
     "synonyms": ["cat", "meow", "purr", "cat meow"], "confident": False},
    {"catid": "ANMLBird", "category": "ANIMALS", "subcategory": "Bird",
     "synonyms": ["bird", "birdsong", "chirp", "tweet", "bird call"], "confident": False},

    # --- GUNS / EXPLOSIONS ---
    {"catid": "GUNHandgun", "category": "GUNS", "subcategory": "Handgun",
     "synonyms": ["gunshot", "pistol", "handgun", "gun fire", "shot"], "confident": False},
    {"catid": "EXPLGeneral", "category": "EXPLOSIONS", "subcategory": "General",
     "synonyms": ["explosion", "blast", "boom", "detonation", "explode"],
     "confident": False},

    # --- CLOTH / PAPER (foley materials) ---
    {"catid": "CLOTHMove", "category": "CLOTH", "subcategory": "Movement",
     "synonyms": ["cloth", "cloth movement", "fabric", "clothing rustle",
                  "cloth rustle"], "confident": False},
    {"catid": "PAPRHandle", "category": "PAPER", "subcategory": "Handling",
     "synonyms": ["paper", "paper rustle", "page turn", "paper crumple"],
     "confident": False},

    # --- MACHINE / ELECTRICITY / COMMS ---
    {"catid": "MACHGeneral", "category": "MACHINES", "subcategory": "General",
     "synonyms": ["machine", "motor", "mechanism", "machinery", "servo"],
     "confident": False},
    {"catid": "ELECBuzz", "category": "ELECTRICITY", "subcategory": "Buzz",
     "synonyms": ["electric buzz", "spark", "zap", "electricity", "arc"],
     "confident": False},
    {"catid": "COMMPhone", "category": "COMMUNICATIONS", "subcategory": "Phone",
     "synonyms": ["phone ring", "telephone", "ringtone", "cell phone",
                  "dial tone"], "confident": False},
]
