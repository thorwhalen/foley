...
[`Aligner`](foley.weave.protocols.html.md#foley.weave.protocols.Aligner) seam, mirroring
[`foley.agent.decompose`](foley.agent.decompose.html.md#module-foley.agent.decompose)’s fake/real discipline exactly:
