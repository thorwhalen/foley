...
Accepts the same facet keywords as [`search()`](foley.index.search.md#module-foley.index.search)’s filters
...
| [`taxonomy`](foley.index.taxonomy.md#module-foley.index.taxonomy)   | UCS + AudioSet taxonomy: the `tags -> UCS CatID` resolver for foley.            |
|-----------------------------------------------------------------------------------------|---------------------------------------------------------------------------------|
| [`embedders`](foley.index.embedders.md#module-foley.index.embedders) | Embedders — the joint text<->audio space that powers retrieval.                 |
| [`indexes`](foley.index.indexes.md#module-foley.index.indexes)     | Concrete vector + keyword index backends (the swappable retrieval engines).     |
| [`ingest`](foley.index.ingest.md#module-foley.index.ingest)       | The ingestion pipeline — turn any audio file into a searchable SoundRecord.     |
| [`library`](foley.index.library.md#module-foley.index.library)     | The `SoundLibrary` façade — one searchable, license-aware sound library.        |
| [`protocols`](foley.index.protocols.md#module-foley.index.protocols) | Structural contracts for the foley index (the retrieval boundary).              |
| [`search`](foley.index.search.md#module-foley.index.search)       | Hybrid retrieval: reciprocal rank fusion over a vector list and a keyword list. |
| [`taggers`](foley.index.taggers.md#module-foley.index.taggers)     | Taggers — auto-fill a sound's semantic labels on ingest (report 03).            |
