...
Pure data: both dataclasses subclass [`SerializableMixin`](foley.base.md#foley.base.SerializableMixin), so
...
|-------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------|
| [`ingest_digest`](#foley.obs.run_artifact.ingest_digest)(report)                                | A leak-free digest of an [`IngestReport`](foley.index.ingest.md#foley.index.ingest.IngestReport) for a manifest. |
