...
[`foley.sources.registry.discover_sources()`](foley.sources.registry.md#foley.sources.registry.discover_sources) can read it cheaply. It maps the
...
[`foley.sources.freesound.adapter`](foley.sources.freesound.adapter.md#module-foley.sources.freesound.adapter).
