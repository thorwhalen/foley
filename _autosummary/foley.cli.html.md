...
is a thin call into the library facade ([`foley.bootstrap()`](foley.html.md#foley.bootstrap), [`foley.demo()`](foley.html.md#foley.demo),
[`foley.ingest()`](foley.html.md#foley.ingest), [`foley.search()`](foley.html.md#foley.search)); the CLI only parses args and prints.
