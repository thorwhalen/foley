...
[`foley.agent.protocols`](foley.agent.protocols.md#module-foley.agent.protocols) exactly.
...
torch-free [`FakeAligner`](foley.weave.align.md#foley.weave.align.FakeAligner) (evenly spaces the
transcript’s words across the clip); [`WhisperXAligner`](foley.weave.align.md#foley.weave.align.WhisperXAligner)
