...
* [`hydrate()`](#foley.weave.timeline.hydrate) — resolve each item’s symbolic anchor into a concrete
  [`Placement`](foley.base.md#foley.base.Placement) and fill processing/id defaults, **idempotently**
...
Idempotent: an item that already carries a [`Placement`](foley.base.md#foley.base.Placement) keeps
