...
`import foley.weave` stays dol-only (mirroring [`foley.audio`](foley.audio.md#module-foley.audio)). Nothing here
...
Thin wrapper over [`foley.audio.fade()`](foley.audio.md#foley.audio.fade) (linear ramps), sized in seconds.
