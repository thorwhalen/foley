...
[`ingest_one()`](foley.index.ingest.md#foley.index.ingest.ingest_one) pipeline.
...
| [`Adapter`](#foley.sources.stable_audio.adapter.Adapter)                                | Registry convention (arioso): the loader imports `adapter.Adapter`.                                                                                   |
|-----------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|
| [`StableAudioAdapter`](#foley.sources.stable_audio.adapter.StableAudioAdapter)([config, pipeline]) | Local Stable Audio Open 1.0 generate adapter (a [`GenerateAdapter`](foley.sources.base.md#foley.sources.base.GenerateAdapter)). |
...
Local Stable Audio Open 1.0 generate adapter (a [`GenerateAdapter`](foley.sources.base.md#foley.sources.base.GenerateAdapter)).
