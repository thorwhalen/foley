...
Normalises the whole program to a [`MasterProfile`](foley.base.md#foley.base.MasterProfile) integrated-loudness
target (ITU-R BS.1770-4 / EBU R128 via `pyloudnorm`) and holds an inter-sample
**true-peak** ceiling. It reuses [`foley.audio.loudness_normalize()`](foley.audio.md#foley.audio.loudness_normalize) (the same
BS.1770 meter Tier-0 QC uses) for the LUFS stage and [`foley.qc.true_peak_dbtp()`](foley.qc.md#foley.qc.true_peak_dbtp)
...
[`foley.weave.requirements`](foley.weave.requirements.md#module-foley.weave.requirements)); everything is lazy so `import foley.weave` stays dol-only.
