...
foley’s unified [`GENERATION_AFFORDANCES`](foley.base.html.md#foley.base.GENERATION_AFFORDANCES) onto the pipeline’s
...
never hand-set) and is enforced by [`foley.keep()`](foley.html.md#foley.keep) at select time.
