...
Scans [`foley.sources`](foley.sources.md#module-foley.sources) for sub-**packages** that declare a `SOURCE_CONFIG`
...
[`foley.sources.base.CORPUS_REGISTRY`](foley.sources.base.md#foley.sources.base.CORPUS_REGISTRY). The two adapter kinds have different
contracts (`search` / `get` / `download` vs `iter_clips` /
`resolve_license`) and different façades ([`foley.add_from()`](foley.md#foley.add_from) vs
[`foley.bootstrap()`](foley.md#foley.bootstrap)). They stay disjoint **by construction**: discovery only
...
| [`discover_sources`](#foley.sources.registry.discover_sources)()                       | Scan [`foley.sources`](foley.sources.md#module-foley.sources) sub-packages for a `SOURCE_CONFIG` and register them.   |
|-------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
...
Scan [`foley.sources`](foley.sources.md#module-foley.sources) sub-packages for a `SOURCE_CONFIG` and register them.

A valid live source is a sub-package of [`foley.sources`](foley.sources.md#module-foley.sources) (`ispkg` and
